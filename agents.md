...
- Practicas: usar `wp_enqueue_scripts` con versionado por `filemtime`, revisar hooks de Genesis antes de modificar layouts, prefijar funciones/filters/actions con `reban_` (o documentar la excepcion si son de terceros), y documentar cambios en `CHANGELOG.md`.
